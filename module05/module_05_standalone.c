...
// clear;gcc module_05_standalone.c ../common.c ../libtermcolor/libtermcolor.c ../libtermcolor/tc_frame.c ../libtermcolor/pseudographic.c ../libtermcolor/tc_file_directories_color.c ../libtermanimation/libtermanimation.c ../libline/libline.c ../libstrprepare/libstrprepare.c ../libtermcontrol/libtermcontrol.c -o module_clock_9 -I../ -I../libtermcolor -I../libtermanimation -I../libline -I../libstrprepare -I../libtermcontrol -lncursesw
