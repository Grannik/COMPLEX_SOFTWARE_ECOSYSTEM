...
#LIBS = -lncursesw -lmagic -luchardet -larchive -lavformat -lavcodec -lavutil -lexif
 LIBS = -lncursesw -lmagic -luchardet -larchive -lavformat -lavcodec -lavutil -lexif -lasound
#PKG_CFLAGS := $(shell pkg-config --cflags libmagic uchardet libarchive libexif libavformat libavutil 2>/dev/null || echo "")
PKG_CFLAGS := $(shell pkg-config --cflags libmagic uchardet libarchive libexif libavformat libavutil alsa 2>/dev/null || echo "")
TARGET = complex_software

SRCS = \
complex_modules.c \
common.c \
libstrprepare/libstrprepare.c \
...
module11/module_11.c \
module12/module_12.c \
module13/module_13.c \
module14/module_14.c
