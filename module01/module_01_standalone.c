...
int main(void) {
    ...
    werase(stdscr);
    group_msg(2, -1, 8, -1,
        10,"/", 19,"/", 27,"|", 31,"/", 40,"|", 44,":", 47,":",
        -1,(const char*)-1);
    return main_loop();
}

// clear;gcc module_01_standalone.c ../common.c ../libtermcolor/libtermcolor.c ../libtermcolor/tc_frame.c ../libtermcolor/pseudographic.c ../libtermcolor/tc_file_directories_color.c ../libtermanimation/libtermanimation.c ../libline/libline.c ../libstrprepare/libstrprepare.c ../libtermcontrol/libtermcontrol.c -o module_clock_1 -I../ -I../libtermcolor -I../libtermanimation -I../libline -I../libstrprepare -I../libtermcontrol -lncursesw
